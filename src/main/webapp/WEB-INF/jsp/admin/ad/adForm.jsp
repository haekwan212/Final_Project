				...
				<input type="hidden" id="AD_NUMBER" name="AD_NUMBER" value="${ad.AD_NUMBER}">	
                        ...
                        <c:when test="${ad.AD_IMAGE != null}">
                         <div class="form-group">
                          ...
                          <div class="form-group">
                        <img src="/SIRORAGI/file/adFile/${ad.AD_IMAGE}" width="100" height="100" alt=""  onerror="this.src='/SIRORAGI/file/noimg_130.gif'" />
                        </div>
                        <div class="form-group">
                            <label>이미지 찾기</label>
						...
						<a href="/SIRORAGI/ad/adList?posting=0&searchNum=0&isSearch="><button type="button" name="searchNum" id="searchNum" class="btn btn-outline btn-default">목록으로</button></a>		
				</form:form>
			</div>
	</div>
</div>
