			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row">
						<div class="col-sm-12">
							<table
								...
								<tbody>
								<c:forEach var="adList"  items="${ad}" varStatus="stat">
								<c:url var="viewURL" value="openAdDetail" >
									<c:param name="AD_NUMBER" value="${adList.AD_NUMBER }" />
								</c:url>									
									<tr class="gradeA even" role="row">
										<td style="text-align:center;vertical-align:middle;">${adList.AD_NUMBER}</td>
										<td style="text-align:center;vertical-align:middle;"><img src="/SIRORAGI/file/adFile/${adList.AD_IMAGE}" width="100" height="100" alt=""  onerror="this.src='/SIRORAGI/file/noimg_130.gif'" /></td>
										<c:choose>
								...
								<!-- 광고가 없을때 -->
									<c:if test="${fn:length(ad) le 0}">
										<tr><td colspan="9" style="text-align:center;">광고가 없습니다.</td></tr>
									</c:if> 
					...
					<div class="row">
	  				...
	  				<a href="/SIRORAGI/ad/adForm"><button type="button" class="btn btn-outline btn-default">광고등록</button></a>		
				</div>
			</div>
			<!-- /.table-responsive -->		
		</div>
