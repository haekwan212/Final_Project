					...
					<ul class="catalog ajax-list row">
						...
						<c:forEach var="goodsList" items="${goodsList}" varStatus="stat">
							...
							<li class="catalog-item col-xs-12 col-sm-6 col-md-4 items_0 c1">
								<div class="thumbnail">
									<a href="${viewURL}"> <img data-original="/SIRORAGI/file/goodsFile/${goodsList.GOODS_THUMBNAIL}"
										...
										<div class="cabal-group">
											...
											<c:if test="${goodsList.GOODS_DCPRICE != null}">
												...
												<fmt:formatNumber value="${(goodsList.GOODS_PRICE - goodsList.GOODS_DCPRICE)*100 / goodsList.GOODS_PRICE}" type="number" />
												%
												</span>
												</span>
											</c:if>
