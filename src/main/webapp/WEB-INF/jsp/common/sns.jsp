...
function postToFeed(){
  FB.ui({
	...
	name : 'PANCOAT [팬콧샵] MULTI TWEEN FLOWER STRIPE SEMI OVER T-SHIRT (MIDNIGHT BLACK)_PPOEURS29VC6',
  	caption: '[팬콧샵] MULTI TWEEN FLOWER STRIPE SEMI OVER T-SHIRT (MIDNIGHT BLACK)_PPOEURS29VC6',
	picture: 'http://pic.styleindex.co.kr/data/goods/pshp/m/149/1496390649',
	description: '[팬콧샵] MULTI TWEEN FLOWER STRIPE SEMI OVER T-SHIRT (MIDNIGHT BLACK)_PPOEURS29VC6',
	}, function(response){});
};
  (function(d, s, id){
