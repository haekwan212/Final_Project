			...
			<div class="dataTable_wrapper">
				<div id="dataTables-example_wrapper"
					...
					<div class="row" style="margin-bottom:5px;">
						<div class="col-sm-6">
							<a href="/SIRORAGI/notice/noticeAdminList"><button type="button" class="btn btn-outline btn-default">전체</button></a>													
						</div>
							...
							<table
								...
								<tbody>
									<c:forEach var="noticeList" items="${noticeList}" varStatus="stat">
										<c:url var="viewURL" value="noticeModifyForm">
											<c:param name="NOTICE_NUMBER" value="${noticeList.NOTICE_NUMBER }" />
										</c:url>
										<tr class="gradeA even" role="row">
											<td style="text-align: center; vertical-align: middle;">${noticeList.NOTICE_NUMBER}</td>
											...
											<td style="text-align: center; vertical-align: middle;"><fmt:formatDate value="${noticeList.NOTICE_REGDATE}" pattern="YY.MM.dd HH:mm" /></td>
											...
											<td style="text-align: center; vertical-align: middle;">
												...
												<c:url var="viewURL2" value="/notice/noticeDelete">
													<c:param name="NOTICE_NUMBER" value="${noticeList.NOTICE_NUMBER }" />
												</c:url>
					...
					<div class="row">
						<div style="text-align: center;">
							...
							<button type="button" onclick="onWrite()"
										class="btn btn-outline btn-default">쓰기</button></div>
						</div>
					</div>
