											...
											<tbody>
												<tr>
													...
													<td class="info-caption"><strong class="brand">팬콧</strong>
														<em class="name">[팬콧샵] POPEAGLE HIDDEN HOODIE
															(A-1/IP) (CHICAGO RED)_PPOIPHD02UR5</em>
														<div class="option">
															<em>사이즈:SS / 1개</em> <a
																href="../order/setoption?no=331905"
																class="button button-dimmed" target="modal"
																data-size="sm" data-label="선택사항 추가/변경"> <span
																class="button-label">옵션변경</span>
															</a>
														</div></td>
													...
													<td class="payment"><span>27,500원</span></td>
													<td class="sale"></td>
													<td class="delivery"><span>2,500원</span> <!-- 배송비없을때 <span>무료</span>-->
													</td>
													<td class="delete"><a href="?mode=del&amp;no=331905"
														class="button button-dimmed"> <span
															class="button-label">삭제</span>
													</a></td>
												</tr>
											</tbody>
										</table>
...
-->
									...
									<ul class="collapse">
										<li>총 상품금액 <b>27,500원</b></li>
										<li>배송비 <b>2,500원</b></li>
										<li>결제금액 <b style="color: #cd2b2b">30,000원</b></li>
									</ul>
						...
						<div class="box-shadow">
							...
							<div class="section-body calculator">
								<div class="price col-sm-8 col-lg-24">
									<div class="sum">
										<em>주문 금액 합계</em> <strong>30,000원</strong>
									</div>
									<div class="detail">
								...
								<div class="discount col-sm-8 col-lg-24">
									<div class="sum">
										<em>할인 금액 합계</em> <strong>-0원</strong>
									</div>
									<div class="detail">
										<div class="item col-xs-12">
											<div class="item-label">
								...
								<div class="total col-sm-8 col-lg-24">
									<div class="sum">
										<em>최종 결제 금액</em> <strong>30,000원</strong>
									</div>
									<div class="detail">
										<p>
