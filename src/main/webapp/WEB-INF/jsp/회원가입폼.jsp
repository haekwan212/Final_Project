...
<head>
	...
	<link rel="stylesheet" href="theme/pshp/css/ui.css">
<style>
.agreement-terms > div .terms{width:100%;}
</style>
</head>
<body>
<div class="viewport">
				...
				<section class="col-xs-24 col-sm-12">
					<div class="box-shadow">
						...
						<div class="section-body">
							<textarea class="terms terms2" readonly="readonly">[팬콧샵 회원 약관 ] - 공정거래위원회 표준약관 제 10023호 를 준수합니다.
제1조(목적) 이 약관은 (주)스타일인덱스 회사(전자상거래 사업자)가 운영하는 지트리트 사이버 몰(이하 “몰”이라 한다)에서 제공하는 
인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
① “몰”이란 (주)스타일인덱스 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 
...
전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 지트리트 사이버몰의 
...
<ul class="section-body">
	...
	<li class="phone">
		...
		<div class="col-lg-21 col-md-20">
			<div class="input-box">
				<input type="text" name="phone[]" id="input-phone01" class="xx-control" value="" maxlength="4">
				<input type="text" name="phone[]" id="input-phone02" class="xx-control" value="" maxlength="4">
				<input type="text" name="phone[]" id="input-phone02" class="xx-control" value="" maxlength="4">
			</div>
			<!--<div class="checkbox">-->
				<!--<label>-->
					...
					<!--<span class="icon icon-checkbox"></span>-->
					<!--<span class="checkbox-label">전화번호 없음</span>-->
				<!--</label>-->
			<!--</div>-->
		</div>
	</li>
	...
	<li class="birth input-placeholder">
		...
		<div class="col-lg-21 col-md-20">
			<div class="input-box">
				...
				<div class="item">
					<input type="text" id="input-birth02" name="birth_month" value="" maxlength="2" placeholder="월" class="xx-control">
				</div>
				<div class="item">
